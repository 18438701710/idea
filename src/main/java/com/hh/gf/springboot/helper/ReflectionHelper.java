 ...
 * @author Joinfun
 * @version 2015年8月28日 16:18:58 王磊 补充头信息*/
...
public class ReflectionHelper {
	...
	public static void invokeSetter(Object obj, String propertyName, Object value) {
		String setterMethodName = SETTER_PREFIX + StringHelper.capitalize(propertyName);
	...
	public static Object getFieldValue(final Object obj, final String fieldName) {
		...
		if (field == null) {
			throw new IllegalArgumentException("Could not find field [" + fieldName + ON_TARGET + obj + "]");
		}
	...
	public static Object invokeMethod(final Object obj, final String methodName, final Class<?>[] parameterTypes, final Object[] args) {
		...
		if (method == null) {
			throw new IllegalArgumentException("Could not find method [" + methodName + ON_TARGET + obj + "]");
		}
